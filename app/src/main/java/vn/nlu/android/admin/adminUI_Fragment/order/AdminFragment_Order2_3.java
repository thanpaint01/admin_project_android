...
public class AdminFragment_Order2_3 extends Fragment {

    private ArrayList<Order> data;
    RecyclerView recycleview_order2_3;
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View root = inflater.inflate(R.layout.admin_fragment_order2_3, container, false);
        recycleview_order2_3 = root.findViewById(R.id.recycleview_order2_3);
    ...
    public void loadData() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Server.admin_donhang2+"?idtinhtrang=3", new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                System.out.println("33333 :" + response);
                try {
    ...
    private void setdata(ArrayList<Order> data) {
        ...
        recycleview_order2_3.setAdapter(adpater);
        recycleview_order2_3.setHasFixedSize(false);
    }
