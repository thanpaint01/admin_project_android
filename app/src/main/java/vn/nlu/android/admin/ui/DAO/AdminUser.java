package vn.nlu.android.admin.ui.DAO;
...
public class AdminUser {
    int limit = 20;
    public ArrayList<String> getUser(int page, Context context) {
        ArrayList<String> data = new ArrayList<String>(limit);
            ...
            public void onResponse(String response) {
                if (!response.trim().equals("error")) {
                    try {
                        ...
                        User user = new User(iduser,taikhoan,ten,img,sdt,diachi,email,gioitinh,ngaysinh,quyen,active);
