...
public class AdminFragment_Order2_1 extends Fragment {

    private ArrayList<Order> data;
    RecyclerView recycleview_order2_1;
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View root = inflater.inflate(R.layout.admin_fragment_order2_1, container, false);
        recycleview_order2_1 = root.findViewById(R.id.recycleview_order2_1);
    ...
    public void loadData() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Server.admin_donhang2+"?idtinhtrang=1", new Response.Listener<String>() {
            @Override
    ...
    private void setdata(ArrayList<Order> data) {
        ...
        recycleview_order2_1.setAdapter(adpater);
        recycleview_order2_1.setHasFixedSize(false);
    }
